...
import { postSignUp } from "../auth/api/useSignUp";
 
// Mock sign-up function
const mockSignUp = async (values: z.infer<typeof signUpFormSchema>) => {
  // Simulate API call
...
function SignUp() {
  ...
  const signUpMutation = useMutation({
    mutationFn: (values: SignUpFormValues) => postSignUp(values),
    onSuccess: (data) => {
      if (data.success) {
        alert(data.message);
      } else {
  ...
  console.log("ok",signUpMutation.variables);
